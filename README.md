...
The Local Event Explorer API is a backend application developed using Node.js, Express, TypeScript, and MySQL. It provides REST API endpoints to manage users, events, and event categories.
...
git clone https://github.com/jay-025/MILESTONE.git
...
Run the provided SQL script to create the event_manager database.
The script will create the following tables:
User
Events
Category
SavedEvents
Update your MySQL credentials in src/db.ts.
